...
Mudanças neste arquivo só viram produção depois de `git add painel-pedidos.html && git commit && git push` — comando roda pelo próprio usuário, não por você.
